...
# FROM: https://github.com/kira-bruneau/nixos-config/blob/ac89f34e541625346d7290669ecdd7f23cb55572/environments/media-server.nix
let
    ...
    preStart = ''
      ...
      ${builtins.concatStringsSep "\n" (
        builtins.map (
          ...
          in "${pkgs.coreutils}/bin/ln -sfn ${lib} \"${config.services.jellyfin.dataDir}/root/default/${name}\""
